...
src="../yeep/headr.png"></a> <a href="imgUpload/">Image Uploader</a>
</div>
<div id="content">	
   ...
   <?php
	...
	?>
		...
		<p><em>Bienvenue sur Yeepr! Vous pouvez des maintenant modifier les acrticles du blog avec vos collaborateur sur ce board.</em></p>
...
?>
	...
	else // Sinon, on affiche un message d'erreur
	{
		...
		<p> Le site peut egalement etre en cours de maintenance. Veulliez reessayer plus tard. </p>
		<p> POWERED BY YEEP</p>';
	}
	?>
	
		<p>Initialement cree par William CLEMENT.</p>
		<p><strong>wiyam</strong></p>
		<p>(L) Yeep</p>
</div>
</center>		
	</body>
